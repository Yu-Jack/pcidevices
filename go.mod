...
replace (
	...
	github.com/harvester/harvester => github.com/Yu-Jack/harvester v0.0.0-20260914080055-8235b6737fe4
	...
	k8s.io/externaljwt => k8s.io/externaljwt v1.34.2
	...
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20250709202758-84b298b067ab
